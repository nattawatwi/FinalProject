                ...
                <div class="modal-body">
                    <form id="postForm" name="postForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" placeholder="Note description" name="description" id="description" cols="12" rows="3"></textarea>
                        </div>
